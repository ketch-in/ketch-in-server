...
var RTCMultiConnection = function (roomid, forceOptions) {
  ...
  function SocketConnection(connection, connectCallback) {
    ...
    console.log("> 시작 3-1-6", parameters);
  ...
  (function (connection) {
    ...
    function connectSocket(connectCallback) {
      console.log("> 시작 3-1-2");
      connection.socketAutoReConnect = true;

      if (connection.socket) {
        console.log("> 시작 3-1-2-1");
        // todo: check here readySate/etc. to make sure socket is still opened
        if (connectCallback) {
          console.log("> 시작 3-1-2-1-1");
          connectCallback(connection.socket);
        }
        return;
      }
      console.log("> 시작 3-1-3");
      ...
      console.log("> 시작 3-1-4", window.SocketConnection);
